...
def run_command(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.command == "burn":
        return burn_subtitles(Path(args.video_path), Path(args.subtitle_path), out=_path_or_none(args.out), font_size=args.font_size, position=args.position)
    ...
    if args.command == "shorten":
        return client.shorten(Path(args.video_path), out=_path_or_none(args.out), max_clips=args.max_clips, target_duration=args.target_duration)
